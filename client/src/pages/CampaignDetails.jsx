...
const CampaignDetails = () => {
  ...
  const hexaDecimalValue = state.target._hex
  const decimalValue = ethers.BigNumber.from(hexaDecimalValue).toString().slice(0, 2);
    ...
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        <div className="flex-1 flex-col">
          <img src={state.image} alt='campaign' className='w-full h-[410px]
          object-cover rounded-xl'/>
          <div className="relative w-full h-[5px] bg-[#3a3a43] mt-2">
            <div
              className="absolute h-fulll bg-[#4acd8d]"
        ...
        <div className="flex md:w-[150px] w-full flex-wrap justify-between gap-[30px]">
          ...
          <CountBox title={`Raised of ${decimalValue}`} value={state.amountCollected} />
          ...
          <div>
            ...
            <div className="mt-[20px] flex flex-row items-center flex-wrap
              ...
              <div className="w-[52px] h-[52px] flex items-center justify-center
                rounded-full bg-[#2c2f32] cursor-pointer">
                <img
                  src={thirdweb}
                  alt="user"
          ...
          <div>
            ...
            <div className="mt-[20px] flex flex-col gap-4">
              {donators.length > 0 ? donators.map((item, index) => (
                <div key={`${item.donators}-${index}`} 
                className="flex justify-between items-center gap-4">
                  <p className="font-epilogue font-normal text-[16px]
                  text-[#b2b3bd] leading-[26px] break-11">{index + 1 } . {item.donator}</p>
                  <p className="font-epilogue font-normal text-[16px]
                  text-[#808191] leading-[26px] break-11">{item.donation}</p>
                </div>
              )): (
                <p className="mt-[4px] font-epilogue font-normal text-[16px] text-[#808191] leading-[26px] text-justify">
        ...
        <div className="flex-1">
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
            ...
            <div className="mt-[30px]">
              ...
              outline-none border-[1px] border-[#3a3a43] bg-transparent font-epilogue
